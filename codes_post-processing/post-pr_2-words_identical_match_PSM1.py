...
TXT_DIR_RAW = 'texts_processed/noiseGSpsm1/' # directory storing OCR result from the images
TXT_DIR_TRU = 'texts_actual/' #directory storing manually prepared correct ingredients lists -> for testing
TXT_DIR_RSLTS = 'results/post-processing_identical_match_2-words_PSM1.txt' #location storing all of the results
