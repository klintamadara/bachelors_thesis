...
TXT_DIR_RAW = 'texts_processed/croppednoise/' # directory storing OCR result from the images
TXT_DIR_TRU = 'texts_actual/' #directory storing manually prepared correct ingredients lists -> for testing
TXT_DIR_RSLTS = 'results/cropped/post-processing_identical_match_2-words_croppednoise.txt' #location storing all of the results
