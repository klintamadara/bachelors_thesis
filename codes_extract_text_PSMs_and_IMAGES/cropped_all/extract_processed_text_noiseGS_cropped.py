...
IMG_DIR = 'images_processed/croppedGS/' # directory with the original images
IMG_DIR_AFTER = 'images_processed/croppednoiseGS/' #directory storing pre-processed images
TXT_DIR = 'texts_processed/croppednoiseGS/' # directory storing OCR result from the pre-processed images
