...
IMG_DIR = 'images_processed/croppedGSpsm1/' # directory with the original images
IMG_DIR_AFTER = 'images_processed/croppednoiseGSpsm1/' #directory storing pre-processed images
